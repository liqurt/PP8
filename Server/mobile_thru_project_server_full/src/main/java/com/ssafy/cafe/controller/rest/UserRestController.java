...
public class UserRestController {
    ...
    @PostMapping("/info")
    @ApiOperation(value = "사용자의 정보와 함께 사용자의 주문 내역, 사용자 등급 정보 그리고 사용자가 입력했던 리뷰들도 반환한다.", response = Map.class)
    public Map<String, Object> getInfo(@RequestBody User user) {
        ...
        if (selected == null) {
            ...
            List<Comment> comments = commService.selectByUser(user.getId());
