...
public class OrderRestController {
    ...
    @GetMapping("/getLast")
    @ApiOperation(value="{id}에 해당하는 사용자의 가장 최근 주문 내역을 반환한다.", response = Order.class)
    public List<Map<String, Object>> getLastOrder(String id) {
        return oService.getLastOrder(id);
    }
